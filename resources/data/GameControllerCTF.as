package §_-V2§
{
   ...
   public class GameControllerCTF extends §_-9M§
   {
      
      public static var $title1:String = "Capture the Flag";
      ...
      public static var $longDescription:String = "Get to the enemy base, grab their flag, and bring it home. You must have both flags to score a point.";
      
      public static var $active = true;
      
      public static var $tinyDescription:String = "CTF";
      ...
      public function GameControllerCTF(param1:§_-LU§, param2:§_-If§, param3:Array, param4:§_-5S§, param5:Boolean)
      {
      ...
      override protected function §_-4m§() : *
      {
         ...
         if(§_-S2§.§_-MG§ == 0)
         {
            §_-5b§.addEventListener(§_-gQ§.FLAG_TOUCHED,§_-3h§,false,0,true);
            §_-5b§.addEventListener(§_-gQ§.§_-YP§,§_-Ag§,false,0,true);
         }
         §_-1d§();
      }
      
      override public function captureComplete(param1:Number, param2:Number) : *
      {
         var _loc3_:Number = NaN;
         var _loc4_:String = null;
         returnFlag(param1);
         §_-dQ§[param2].carryingFlag = 0;
         if(§_-P5§ && !§_-l0§)
         {
            §_-S2§.§_-mn§[param2].matchCurrency += §_-UF§;
            §_-9w§(param2,§_-UF§);
            if(param1 == 1)
            {
               _loc3_ = 2;
            ...
            ++§_-QF§[_loc3_];
            §_-aK§(§_-QF§[1],§_-QF§[2]);
            §_-5b§.§_-ia§.§_-XH§(§_-S2§.§_-mn§[param2].userName,"capture",param1);
            if(§_-S2§.§_-MG§ == 0)
            {
               if(§_-QF§[_loc3_] >= §_-4H§ || §_-J2§ < 0 && ChazTools.isThisTheHighestValueInArray(_loc3_,§_-QF§))
               {
                  if(_loc3_ == 1)
                  {
                     _loc4_ = "Blue Team";
                  ...
                  §_-8I§(_loc4_);
                  §_-S2§.§_-SB§.§_-19§.send("recvMatchComplete",_loc4_);
      ...
      override public function set matchData(param1:GameControllerMatchData) : *
      {
         ...
         {
            _matchBoxSmall.§_-7p§(§_-J2§,false,"CTF");
         }
         §_-aK§(§_-QF§[1],§_-QF§[2]);
         if(§_-P5§ && !§_-l0§)
         {
      ...
      override public function §_-PQ§() : *
      {
         ...
         _matchBoxSmall.§_-7p§(§_-6X§,false,"CTF");
         var _loc1_:* = 0;
